    ...
    if request.method == "GET":
        ...
        try:
            ...
            return jsonify({"status": "ok"}), 200
                    ...
                    # Step 10: ask_student_age
                    if step == "ask_student_age":
                        # Use msg (already extracted)
                    ...
                    # Fallback for unknown steps or unhandled messages
